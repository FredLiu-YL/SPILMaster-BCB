...
/* Image Persistence */
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonImagePersistenceSave(EPylonImageFileFormat imageFileFormat,  const char* pFilename, void * pBuffer, size_t bufferSize, EPylonPixelType pixelType, uint32_t width, uint32_t height, size_t paddingX, EPylonImageOrientation orientation, PylonImagePersistenceOptions_t* pOptions);
...
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonAviWriterAdd(PYLON_AVI_WRITER_HANDLE hWriter, void* pBuffer, size_t bufferSize, EPylonPixelType pixelType, uint32_t width, uint32_t height, size_t paddingX, EPylonImageOrientation orientation, EPylonKeyFrameSelection keyFrameSelection);
...
PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonImageWindowSetImage(size_t winIndex, void* buffer, size_t bufferSize, EPylonPixelType pixelType, uint32_t width, uint32_t height, size_t paddingX, EPylonImageOrientation orientation);

PYLONC_API GENAPIC_RESULT PYLONC_CC PINVOKE_DOC
PylonImageWindowDisplayImage(size_t winIndex, void* buffer, size_t bufferSize, EPylonPixelType pixelType, uint32_t width, uint32_t height, size_t paddingX, EPylonImageOrientation orientation);
