...
IIMAGE_API HBITMAP* __cdecl iGetBitmapAddressPtr(LONG_PTR iImg);
IIMAGE_API HBITMAP  __cdecl iGetBitmapAddress(LONG_PTR iImg);

IIMAGE_API E_iVision_ERRORS __cdecl iPointerToiImage(LONG_PTR iImg,LONG_PTR DataSrc,int wid,int hei);
IIMAGE_API E_iVision_ERRORS __cdecl iPointerFromiImage(LONG_PTR iImg,LONG_PTR DestData,int wid,int hei);
IIMAGE_API UINT32 __cdecl GetBufferSize(LONG_PTR iImg);
